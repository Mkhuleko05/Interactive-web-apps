...
const donuts = order2.querySelector('.donuts.count');
const pancakes = order2.querySelector('.pancakes.count');
...
biscuits3.textContent = order3.getAttribute('data-biscuits3'),
donuts3.textContent = order3.getAttribute('data-donuts3'),
pancakes3.textContent = order3.getAttribute('data-pancakes3'),
